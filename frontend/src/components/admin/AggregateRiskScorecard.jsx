    ...
    <div className="bg-white rounded-xl border border-slate-200 p-3 sm:p-5 overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        <MetricCard
          ...
          subtitle={num(m.sharpe_ratio) > 1 ? 'Good risk-adjusted returns' : num(m.sharpe_ratio) > 2 ? 'Excellent' : 'Below threshold'}
        ...
        <MetricCard
          ...
          subtitle={`${num(m.win_count)} wins / ${num(m.loss_count)} losses`}
