...
export default function SummaryCards() {
  ...
  const cards = [
    ...
    },
    {
      ...
      subtitle: data.bench_cagr ? `vs Nifty: ${formatPct(data.bench_cagr)}` : 'Since inception',
      iconColor: 'bg-teal-50',
    ...
    },
    {
      ...
      subtitle: data.bench_max_dd ? `vs Nifty: ${formatPct(data.bench_max_dd)}` : 'Peak to trough',
      iconColor: 'bg-red-50',
